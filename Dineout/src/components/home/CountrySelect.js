      ...
      renderOption={(props, option) => (
        ...
        >
          {/* <img
            loading="lazy"
            width="20"
            src={`https://tse1.mm.bing.net/th?id=OIP.otIPf0nD6Sxy3HcAhQJnGAHaE8&pid=Api&P=0&w=244&h=162`}
          ...
          >
            ...
            {/* <div className={styles.rate}>{option.rating}</div> */}
          </div>
        </Box>
      )}
      renderInput={(params) => (
...
const countries = [
  {
    code: "https://tse1.mm.bing.net/th?id=OIP.otIPf0nD6Sxy3HcAhQJnGAHaE8&pid=Api&P=0&w=244&h=162",
    label: "Andorra",
    phone: "376",
  },
  {
